...
void MainMenuView::refreshPositions()
{
    ...
    const std::vector<cocos2d::Node*> buttons = {
        m_startGameButton,
        m_hostGameButton,
        m_joinGameButton,
        m_settingsGameButton,
    ...
    {
        button->setPosition(cocos2d::Vec2(buttonPosX, buttonPosY));
...
{
    m_startGameButton = ButtonUtils::createButton(cocos2d::Vec2::ZERO,
                                                  GameViewConstants::BUTTON_SIZE_MENU,
                                                  "Debug Local",
                                                  GameViewConstants::FONT_SIZE_LARGE);
    m_hostGameButton = ButtonUtils::createButton(cocos2d::Vec2::ZERO,
                                                 GameViewConstants::BUTTON_SIZE_MENU,
                                                 "Host Game",
                                                 GameViewConstants::FONT_SIZE_LARGE);
    m_joinGameButton = ButtonUtils::createButton(cocos2d::Vec2::ZERO,
                                                 GameViewConstants::BUTTON_SIZE_MENU,
                                                 "Join Game",
                                                 GameViewConstants::FONT_SIZE_LARGE);
    m_settingsGameButton = ButtonUtils::createButton(cocos2d::Vec2::ZERO,
                                                 GameViewConstants::BUTTON_SIZE_MENU,
                                                 "Settings",
                                                 GameViewConstants::FONT_SIZE_LARGE);
    m_replayEditorButton = ButtonUtils::createButton(cocos2d::Vec2::ZERO,
                                                 GameViewConstants::BUTTON_SIZE_MENU,
                                                 "Replay Editor",
                                                 GameViewConstants::FONT_SIZE_LARGE);
    m_exitGameButton = ButtonUtils::createButton(cocos2d::Vec2::ZERO,
                                                 GameViewConstants::BUTTON_SIZE_MENU,
                                                 "Exit Game",
                                                 GameViewConstants::FONT_SIZE_LARGE);
...
void MainMenuView::createPlayerNode()
{
