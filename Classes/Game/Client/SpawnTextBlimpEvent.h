...
class SpawnTextBlimpEvent : public Event
{
public:
    SpawnTextBlimpEvent(const std::string text, const cocos2d::Vec2 position, const int size, const float duration, const cocos2d::Color4B& color);
    
    virtual DescriptorType type() const { return descriptor; }

    static constexpr DescriptorType descriptor = "SpawnTextBlimp";
